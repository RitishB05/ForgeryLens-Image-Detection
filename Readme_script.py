...
# Content for the detailed README
readme_content = """# ForgeryLens: Detecting Digital Image Forgery 🔍
...
* **Sarthak (25AI60R11)**: Developed and optimized the specialized lightweight **EliteNet** and **EfficientNet** backbones. Led the **Transfer Learning** strategy and fine-tuning on the CASIA v2.0 dataset.
...
def generate_readme():
    try:
        ...
        print("✅ Success: Detailed README.md has been generated.")
